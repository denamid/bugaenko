...
#Ну и тут все через циклы, но и тема ведь циклы, так что все вроде четко. Так же мог легко убрать ошибку, если вводить слишком большое число, указав максимальное числа х и у но это тоже понял только вот как дописал
print("Введите два числа для анализа диапазона")     #Но главное что все работает, если специально не пытатся ломать программу. А если случайно ошибится, то попросит испавить
x = input("Начало диапазона: ")
y = input("Конец диапазона: ")
if x.lstrip("-""+").isdigit() == False or y.lstrip("-""+").isdigit() == False or (y>x) == False: #Убираем ошибки, если вводят значения + или -, или же буквы, заствляя вводить по новой значение
